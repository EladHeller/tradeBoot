const contentOfPage = (title, callback) => fetch(`https://he.wikipedia.org/w/api.php?action=query&format=json&prop=revisions&rvprop=content&titles=${title}`)
  .then((res) => res.json())
  .then((res) => {
...
const getLangLinkName = async (name, srcLng, destLang) => {
